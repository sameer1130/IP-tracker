...
export default function Ipform(){
    return (<div className="items-center">
        ...
        <input type="text" placeholder="Search for any IP address or domain" className="mt-20 w-96 h-12 rounded-full bg-white text-slate-200 pl-4 focus:outline-none"/>
        ...
        <button type="submit" className="mt-20 -ml-16 text-white bg-slate-700 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-white-300 font-medium rounded-full text-sm px-4 py-3.5">Search</button>
        </div>
    </div>);
}